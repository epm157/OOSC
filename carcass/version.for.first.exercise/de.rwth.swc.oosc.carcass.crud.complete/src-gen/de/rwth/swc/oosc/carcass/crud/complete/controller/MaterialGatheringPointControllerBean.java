...
public class MaterialGatheringPointControllerBean
...

	{
		...
		// Add the attribute
		customer.addMaterialGatheringPointToMaterialGatheringPoints(materialGatheringPoint);
...

	{
		...
		customer.removeMaterialGatheringPointFromMaterialGatheringPoints(materialGatheringPoint);
